...
let pixel6 = new Phone('Google', 'Pixel 6', '256GB', 'Black', 850);
let iPhone = new Phone('Apple', '12', '256GB', 'Gold', 1200);
let galaxyFlip = new Phone('Samsung', 'Galaxy Flip', '1000GB', 'White', 1500);
...
pixel6.changePrice(1000);
console.log(pixel6.price);
...
const myFirstVehicle = new Vehicle (8, 'space grey', 12000);
...
const myFirstMotorcycle = new Motorcycle (2, 'black', 4000, 'Honda', true);
...
class Boat extends Vehicle {
  ...
  checkSeaworthiness(){
    if (this.isSeaworthy === true){
      console.log(`Your ${this.color} ${this.type}, ${this.name} is seaworthy!`);
    } else {
      console.log(`You need to geth your ${this.type} in shape!`);
    }
  }
}
  performMaintenance(){
...
//Code Here
const myFirstBoat = new Boat(12, 'white', 8500, 'old faithful', 'fishing boat', false);
